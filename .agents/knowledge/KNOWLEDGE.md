...
| OpenShift / KubeVirt destroy | recorded guest remains after destroy; host kubeconfig missing before VM deletion; `KubeVirt host cluster ... is unreachable`; `--skip-unreachable cannot prove them absent` | [destroy-scoping-and-sweeps.md](destroy-scoping-and-sweeps.md) |
