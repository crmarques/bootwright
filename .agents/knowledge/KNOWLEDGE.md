...
| Distribution-table-driven Ceph packaging and its traps: pinning cephadm's upgrade-discovery image base, mgr registry-store credential rotation, the community EPEL/CentOS-Stream dependency bootstrap on unregistered RHEL, vendor license markers, and RHSM idempotence. | [ceph-distribution-packaging.md](ceph-distribution-packaging.md) |
