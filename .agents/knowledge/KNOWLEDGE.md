...
| Destroy gate extra-var vocabulary and its single composition point, the storage work-set tri-state, root-gated record cleanup, the three-kind orphan-sweep allowlist, partial-destroy bookkeeping ordering, shared-service release/block planning, and `--purge-history`'s scope and deliberate exclusions. | [destroy-scoping-and-sweeps.md](destroy-scoping-and-sweeps.md) |
