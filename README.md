...
| `CustomPlaybook` | An operator-supplied Ansible playbook injected into the provisioning DAG at a chosen sub-phase, with optional vendored roles and collections |
