...
`cluster-infra.yaml` overlays. `provider.yaml` also declares a bastion-hosted
HTTP artifact publisher so Redfish virtual media can fetch the generated agent
ISO from the bastion.
