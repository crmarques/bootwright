...
func TestInfraDestroyRecordsSubstrateRelease(t *testing.T) {
	...
	problems := ResetConvergeRecordsAfterDestroy(runsDir, clustersDir, InfraScope, st, nil, nil, nil)
	if len(problems) != 0 {
...
func TestClustersDestroyRecordsNoSubstrateRelease(t *testing.T) {
	...
	ResetConvergeRecordsAfterDestroy(runsDir, clustersDir, ClustersScope, st, nil, nil, nil)
...
func TestFailedMachineTeardownRecordsNoSubstrateRelease(t *testing.T) {
	...
	ResetConvergeRecordsAfterDestroy(runsDir, clustersDir, InfraScope, st, nil, nil, succeeded)
