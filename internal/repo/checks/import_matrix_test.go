...
var allowedImports = map[string][]string{
	...
	"internal/render/inventory": {"api/v1alpha1", "internal/addons/inputs", "internal/entitlements", "internal/infra/artifacts", "internal/infra/locality", "internal/infra/media", "internal/infra/proxy", "internal/ownership", "internal/render/ceph", "internal/render/installer", "internal/roles", "internal/secrets", "internal/sshtrust", "internal/state/graph", "internal/state/view", "internal/storage/cephprovider", "internal/storage/datafoundation", "internal/storage/topology"},
