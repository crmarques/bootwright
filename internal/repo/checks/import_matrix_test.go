...
var allowedImports = map[string][]string{
	...
	"internal/cli": {
		...
		"internal/storage/cephprovider", "internal/storage/cephstate", "internal/storage/topology", "internal/workspace",
	},
	"internal/cli/output": {},

	"internal/state/desired":  {"api/v1alpha1", "internal/addons/steps", "internal/host/gitcontent", "internal/addons/inputs", "internal/addons/nativecatalog", "internal/entitlements", "internal/infra/artifacts", "internal/infra/media", "internal/nmstate", "internal/roles", "internal/state/graph", "internal/state/view", "internal/storage/cephprovider", "internal/storage/topology"},
	...
	"internal/state/advice": {"api/v1alpha1", "internal/storage/cephprovider", "internal/storage/topology"},
	...
	"internal/render":           {"api/v1alpha1", "internal/host/managedroot", "internal/host/safefs", "internal/infra/media", "internal/ownership", "internal/render/ceph", "internal/render/installer", "internal/render/inventory", "internal/roles", "internal/secrets", "internal/state/graph", "internal/state/view", "internal/storage/topology"},
	...
	"internal/addons":               {},
	"internal/addons/steps":         {"api/v1alpha1", "internal/addons/inputs"},
	...
	"internal/addons/oc":            {"api/v1alpha1", "internal/addons", "internal/addons/steps", "internal/addons/plan", "internal/addons/records", "internal/addons/render", "internal/host/execution", "internal/host/shellquote"},
	...
	"internal/preflight":     {"api/v1alpha1", "internal/addons/inputs", "internal/addons/plan", "internal/converge/bastion", "internal/converge/remedy", "internal/host/callerio", "internal/host/execution", "internal/host/safefs", "internal/infra/locality", "internal/infra/media", "internal/secrets", "internal/sshtrust", "internal/state/view", "internal/storage/topology", "internal/workspace"},
	...
	"internal/clusteraccess": {"api/v1alpha1", "internal/converge/remedy", "internal/converge/workflow", "internal/host/safefs", "internal/host/shellquote", "internal/render", "internal/secrets", "internal/state/graph", "internal/state/view", "internal/storage/topology"},
}
