...
// Consumption predicates classify how the desired state consumes a named
// secret. Materialization, listing, and encryption decisions all derive the
// material roles for a secret from these answers.
