...
func TestLocalRootGateArgs(t *testing.T) {
	cases := []struct {
		...
		{args: []string{"media", "delete", "--name", "rhel.iso"}, want: true},
		{args: []string{"media", "delete", "rhel.iso"}, want: false},
		...
		{args: []string{"container-cluster"}, want: false},
		{args: []string{"container-cluster", "kubeconfig", "--name", "managed-01"}, want: true},
		{args: []string{"container-cluster", "oc", "--name", "managed-01", "get", "nodes"}, want: true},
		{args: []string{"container-cluster", "oc", "get", "nodes"}, want: false},
		{args: []string{"container-cluster", "kubectl", "--name", "managed-01", "get", "pods"}, want: true},
		{args: []string{"container-cluster", "kubectl"}, want: false},
		{args: []string{"storage-cluster"}, want: false},
		{args: []string{"storage-cluster", "replace-arbiter", "--name", "ceph-prd-01"}, want: true},
		{args: []string{"storage-cluster", "replace-arbiter"}, want: false},
