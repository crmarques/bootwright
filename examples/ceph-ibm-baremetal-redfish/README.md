...
refuses to run without `--override`.

```bash
bootwright destroy --stage clusters --override --yes   # remove Ceph services
bootwright destroy --stage infra    --override --yes   # power off / deprovision nodes
```
