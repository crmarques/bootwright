...
developer with pytest installed locally can `pytest ansible/filter_plugins/`.

The filter lives at ansible/filter_plugins/credentials.py and is loaded
into Ansible via ANSIBLE_FILTER_PLUGINS (see Makefile ANSIBLE_SYNTAX_ENV).
...
# the ansible/filter_plugins/ directory being on sys.path.
